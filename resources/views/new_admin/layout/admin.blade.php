            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.users.index') }}" class="text-white-50">Пользователи</a>
                            <a href="{{ route('admin.products.index') }}" class="text-white-50">Товары</a>
                            <a href="{{ route('admin.orders.index') }}" class="text-white-50">Заказы</a>
                            <a href="{{ route('admin.booking.index') }}" class="text-white-50">Бронь столов</a>
                        </li>
                    </ul>
                </div>
            </div>

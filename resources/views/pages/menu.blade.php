        ...
        <div class="position-relative p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    @if(\Illuminate\Support\Facades\Auth::user())
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            <a href="{{ route('product') }}" class="nav-item nav-link active">Меню</a>
            ...
            <div class="py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Наше меню</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Главная</a></li>
                            <li class="breadcrumb-item"><a href="#">Ещё</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Наше меню</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Меню</h5>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-100 d-flex flex-column text-start ps-4">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    @if($item->count > 0)
                                                        <a href="{{ route('basket.store', $item) }}">Купить</a>
                                                    @else
                                                        <p>Нет в наличии</p>
                                                    @endif
                                                </div>

        ...
        <div class="position-relative p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    @if(\Illuminate\Support\Facades\Auth::user())
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            <a href="{{ route('service') }}" class="nav-item nav-link active">Сервис</a>
            ...
            <div class="py-5 bg-dark hero-header mb-5">
                <div class="container text-center my-5 pt-5 pb-4">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Сервис</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Главная</a></li>
                            <li class="breadcrumb-item"><a href="#">Страницы</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Сервис</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Предоставляемый сервис</h5>
                    <h1 class="mb-5">Ознакомьтесь с нашими услугами</h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Сервис</h5>
                                <p>Последовательность действий персонала от встречи гостя до его ухода из заведения.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Наивысшие блюда</h5>
                                <p>Блюда высокой кухни со всего мира в одном месте. Цена = качество.</p>
                            </div>
                        </div>
                    </div>

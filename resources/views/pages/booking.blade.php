...
<head>
    <meta charset="utf-8">
    <title>Дуршлаг - Заказ столика</title>
...
<body>
    <div class=" bg-white p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    @if(\Illuminate\Support\Facades\Auth::user())
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            ...
                            <a href="{{ route('booking') }}" class="nav-item nav-link active">Забронировать столик</a>
        ...
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
            {{--                        Я недопрогроммист извините пжпжпжжпжп--}}
            @if(count($errors) > 0)
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" name="orderDate"/>
                                        <label for="datetime">Date & Time</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class= "form-control datetimepicker-input" name="peoples" id="select1" type="number">
                                        <label for="select1">No Of People</label>
                                      </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" id="message" style="height: 100px" name="description"></textarea>
